 ...
 */
data class ScaledImage(val resources: Resources, val width: Int, val height: Int, val bitmapR: Int, val imageQuality: String) {
        ...
        when(imageQuality) {
            ...
            "High" ->
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    options.inPreferredConfig = Bitmap.Config.RGBA_F16 //high quality bitmaps, requires min sdk v26
                } else {
